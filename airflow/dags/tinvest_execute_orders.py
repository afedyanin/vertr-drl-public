...
with DAG(
    ...
    schedule_interval='4/15 6-23 * * 1-5',  # Every 15 minutes, starting at 1 minutes past the hour
    ...
    def post_order(**kwargs):
        ...
        risk_engine.post_order()

    execute_orders_2min_of15 = PythonOperator(
        task_id='execute_orders_2min_of15',
